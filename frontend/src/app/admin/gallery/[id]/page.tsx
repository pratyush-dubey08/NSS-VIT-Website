          ...
          <div className="flex justify-between items-start mb-6">
            ...
            {!isEditing ? (
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => { setIsEditing(false); setEditCover(null); setEditTitle(folder.title); setEditCategoryId(folder.categoryId); }} className="p-2 text-gray-500 hover:bg-gray-100 rounded-lg">
                  <X size={20} />
                </button>
